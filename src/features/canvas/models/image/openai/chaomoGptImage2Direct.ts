...
export const imageModel: ImageModelDefinition = {
  id: CHAOMO_GPT_IMAGE2_4K_DIRECT_MODEL_ID,
  mediaType: 'image',
  displayName: 'gpt-image2-4K-Direct',
  providerId: CHAOMO_IMAGE_PROVIDER_ID,
  description: '4K Direct 多比例生成与参考图编辑',
  eta: '2min',
  ...
  resolveRequest: ({ referenceImageCount }) => ({
    requestModel: CHAOMO_GPT_IMAGE2_4K_DIRECT_MODEL_ID,
