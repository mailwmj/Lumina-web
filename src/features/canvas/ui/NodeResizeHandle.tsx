...
export function NodeResizeHandle({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute bottom-0 right-0 h-3 w-3 border-b border-r border-[var(--ui-border-strong)] transition-colors hover:border-accent" />
    </NodeResizeControl>
  );
}
