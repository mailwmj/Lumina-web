...
export function CropToolEditor({ plugin, sourceImageUrl, options, onOptionsChange }: VisualToolEditorProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      {aspectMode === 'custom' && (
        <div className="flex items-center gap-2">
          <input
            ...
            className="h-9 w-[220px] rounded-lg border border-[var(--ui-border-soft)] bg-[var(--ui-surface-field)] px-3 font-mono text-sm text-text-dark outline-none focus:border-accent"
          />
      ...
      <div
        ref={viewportRef}
        className="relative h-[min(62vh,640px)] rounded-[10px] border border-[var(--ui-border-soft)] bg-[var(--ui-surface-field)]"
      >
